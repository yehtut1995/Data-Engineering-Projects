...
# In this job, I use pure pyspark dataframes syntax to extract the data
# Initialize Glue context and Spark session
# look at the parameters that it requires: a target path where data will be stored, the API endpoint URL and a start and end date that are required by each API endpoint
